namespace CruiseControlNet.SelfHost.Console.Helpers
{
    ...
    public static class ProjectStatusExtensions
    {
        ...
        /// <returns>
        /// The new <see cref="Models.ProjectSummary"/>.
        /// </returns>
        public static Models.ProjectSummary ToModel(this ProjectStatus projectStatus)
        {
            // These properties are always needed
            var model = new Models.ProjectSummary
                {
                    ...
                    Times = new Models.ProjectSummaryTimes
                        {
            ...
            {
                model.Labels = new Models.ProjectSummaryLabels();
                if (hasLastBuild)
                {
