namespace CruiseControlNet.SelfHost.Console.Controllers
{
        ...
        : ApiController
    {
        ...
        /// </returns>
        [Queryable]
        public IQueryable<Models.ProjectSummary> GetAll()
        {
        ...
        /// </returns>
        [Queryable]
        public IQueryable<Models.ProjectSummary> GetByCategory(string category)
        {
            if (this.cruiseServer == null)
            {
                return null;
        ...
        /// The project details.
        /// </returns>
        public Models.ProjectSummary GetById(string id)
        {
            if (this.cruiseServer == null)
            {
                return null;
        ...
        #region PostCommand()
        public Models.CommandStatus Force(string id, Models.Command command)
        {
            return new Models.CommandStatus { Success = true, Message = "Build has been queued" };
        }
        #endregion
        #endregion
    }
